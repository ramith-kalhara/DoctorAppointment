      ...
      <div className="container-fluid bg-dark text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div className="container py-5">
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <h5 className="text-light mb-4">Department</h5>
              <Link className="btn btn-link" to="/team?department=Cardiology">Cardiology</Link>
              <Link className="btn btn-link" to="/team?department=Gynecology">Gynecology</Link>
              <Link className="btn btn-link" to="/team?department=Neurology">Neurology</Link>
              <Link className="btn btn-link" to="/team?department=Orthopedics">Orthopedics</Link>
              <Link className="btn btn-link" to="/team">see all</Link>
